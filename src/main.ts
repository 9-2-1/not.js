...
void ((window as Window & { tempExt?: ExportInfo<unknown> }).tempExt =
  ((): ExportInfo<unknown> => {
    const iconURL =
      ...
      insetIconURL =
        'data:image/svg+xml;base64,'
    return {
      Extension: class {
        /**
         * @brief 格式化消息。
